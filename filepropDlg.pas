...
type
  ...
  private
    iconOfs: integer;
    procedure DoShow(fileTree: TFileTree; selectedFile: Tfile; fileSrv: TFileServer);
  public
...
procedure TfilepropFrm.DoShow(fileTree: TFileTree; selectedFile: Tfile; fileSrv: TFileServer);
var
  i: integer;
  f: Tfile;
  ...
  procedure setText(var v: string; box: TCustomEdit); OverLoad;
  const
    COLOR = clInfoBk;
  var
    n: integer;
  ...
  procedure setText(var v: UnicodeString; box: TCustomEdit); OverLoad;
  const
    COLOR = clInfoBk;
  var
    n: integer;
...
var
  ...
  procedure applyText(var v: UnicodeString; box:TCustomEdit); OverLoad;
  begin
    if box.modified then
      v := box.Text;
  end; // applyText
